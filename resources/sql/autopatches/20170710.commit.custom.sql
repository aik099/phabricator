CREATE TABLE {$NAMESPACE}_repository.repository_customfieldstorage (
...
CREATE TABLE {$NAMESPACE}_repository.repository_customfieldstringindex (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  objectPHID VARCHAR(64) NOT NULL COLLATE utf8_bin,
...
CREATE TABLE {$NAMESPACE}_repository.repository_customfieldnumericindex (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  objectPHID VARCHAR(64) NOT NULL COLLATE utf8_bin,
  indexKey VARCHAR(12) NOT NULL COLLATE utf8_bin,
