  ...
  protected function buildCustomEditFields($object) {
    ...
    return array(
      ...
      id(new PhabricatorSelectEditField())
        ->setKey('layout')
        ->setLabel(pht('Layout'))
        ->setTransactionType(PhabricatorRepositorySVNLayoutTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
        ->setOptions(array(
      ...
      id(new PhabricatorTextEditField())
        ...
        ->setTransactionType(
          PhabricatorRepositorySVNTrunkFolderTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhabricatorTextEditField())
        ...
        ->setTransactionType(
          PhabricatorRepositorySVNBranchesFolderTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhabricatorTextEditField())
        ...
        ->setTransactionType(
          PhabricatorRepositorySVNTagsFolderTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
