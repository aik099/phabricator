...
final class PhabricatorCommitCoAuthoredWithAIField
  extends PhabricatorCommitStoredCustomField {

  public function getFieldKey() {
    return 'diffusion:co-authored-with-ai';
  }
  ...
  public function getFieldDescription() {
    return pht('Marks this commit as co-authored with an AI tool.');
  }
