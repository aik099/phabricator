...
final class PhabricatorQualityRuleHasCommitEdgeType extends PhabricatorEdgeType {
  ...
  public function getConduitKey() {
    return 'quality-rule.commit';
  }

  public function getConduitName() {
    return pht('Quality Rule Has Commit');
  }

  public function getConduitDescription() {
    return pht(
      'The source quality rule is associated with the destination commit.');
  }
